...
module.exports = function(app) {
  ...
  app.post('/api/createParticipat', async function (req, res) {
    ...
    await db.game_participation.create({"user_id": user_id, "ip_hash" :ip_hash, "sex_id": sex_id, "country_id": country_id, "location_id": location_id, "age_id": age_id, "language_ids": languages, "education_id": education_id, "locale": lang, "universe": universe, "score_bot": score}).catch(err => {
      console.error(err);
      res.status(500).json({
        success: false
      });
