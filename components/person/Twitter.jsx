          ...
          <div className="twitter-section">
            ...
            <div className="tw-userinfo">
              <img
                ...
                alt={`${user.screen_name} twitter profile picture`}
              />
              <h3>
                {user.name}{" "}
                <a
            ...
            <div className="tw-userstats">
              <ul className="metrics-list">
                <li className="metric">
                  <h4>{formatAbbreviate(user.followers_count)}</h4>
                  <p>Followers</p>
                </li>
                <li className="metric">
                  <h4>{formatAbbreviate(user.friends_count)}</h4>
                  <p>Following</p>
                </li>
                <li className="metric">
                  <h4>
                ...
                <li className="metric">
                  <h4>{formatAbbreviate(user.statuses_count)}</h4>
                  <p>Tweets</p>
                </li>
              </ul>
            </div>
                  ...
                  <div className="tweet-body">
                    ...
                    <div className="body">
                      <div className="inner-body">
                        ...
                        <div className="handle">@{d.user.screen_name}</div>
                        <div className="time">
                          {renderTweetDate(d.created_at)}
                        </div>
                      </div>
                      ...
                      {d.quote ? (
                        <div className="tweet-body">
                          <img
                            src={d.quote.user.profile_image_url_https}
                            alt="Logo"
                            className="picture"
                          />
                          <div className="body">
                            <div className="inner-body">
                              <div className="name">{d.quote.user.name}</div>
                              <div className="handle">
                                @{d.quote.user.screen_name}
                              </div>
                              <div className="time">
                                {renderTweetDate(d.quote.created_at)}
                              </div>
                            </div>
                            <div className="tweet">{d.quote.text}</div>
                          </div>
                        </div>
                      ) : null}
                    </div>
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              View more {/* <Icon icon="share" iconSize={15} /> */}
            </a>
          </div>
        ) : null}
      </div>
...
//     axios.get(`/api/twit/${person.id}`).then((res) => {
//       const { data } = res;
//       this.setState(data);
//     });
//   };
