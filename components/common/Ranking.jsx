...
const PersonAnchor = ({person, type}) =>
  <a href={`/profile/person/${person.id}/`}>
    {person.name} ({ type === "birthcountry" ? person.birthyear : person.birthcountry.toUpperCase()})
  </a>;
...
const Ranking = ({person, rankings, type}) => {
  ...
  rankings = rankings.map(ranking => Object.assign({}, ranking, {
