...
module.exports = function(app) {
  ...
  app.post('/api/createParticipant', async function (req, res) {
    ...
    const {lang, location_id, education_id, country_id, age_id, sex_id, languages, user_id, token, universe, scoreDB} = req.body;
    ...
    if (scoreDB > -1){
      const participant = {"user_id": user_id, "ip_hash" :ip_hash, "sex_id": sex_id, "country_id": country_id, "location_id": location_id, "age_id": age_id, "language_ids": languages, "education_id": education_id, "locale": lang, "universe": universe, "score_bot": scoreDB};
