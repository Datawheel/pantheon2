...
import f1 from "images/about/methods/1.png";
import f2 from "images/about/methods/2.png";
import f3 from "images/about/methods/3.png";
import f4 from "images/about/methods/4.png";
    ...
    <div>
      <div className="section long-text">
        ...
        <div className="formulas">
          <p><img src={f1} className="f1" alt="L*=exp(H_i)" /></p>
          <p><img src={f2} className="f2" alt="H_i=the negative sum of v_ij divided by the sum of v_kj, multiplied by the natural log of v_ij divided by the sum of v_kj" /></p>
          <p><img src={f3} className="f3" alt="CV_i=sigma_i divided by mu_i" /></p>
          <p><img src={f4} className="f4" alt="HPI_i=natural log of L_i, plus the natural log of L*_i, plus the product of natural log of Ai divided by the natural log of 4, plus the natural log of mu_i to the NEth power, minus the natural log of CV_i" /></p>
        </div>
