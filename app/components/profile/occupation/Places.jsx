  ...
  return (
    <div>
      <p>
        ...
        By city, most {plural(occupation.occupation)} were born in <AnchorList items={placesBorn.slice(0, 3)} name={d => `${d.value.birthplace.name}  (${d.value.num_people})`} url={d => `/profile/place/${d.value.birthplace.slug}/`} />.
      </p>
    </div>
  );
}
