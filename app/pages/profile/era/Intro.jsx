...
const Intro = ({era, eras, peopleBorn, peopleDied}) => {
  ...
  const cities = nest()
    .key(d => d.place.id)
    .rollup(leaves => ({num_died: leaves.length, city: leaves[0].place}))
    .entries(peopleDied.filter(d => d.place))
    ...
    <div className="intro-content">
      <div className="intro-text">
        ...
        <p>
          ...
          The most important cities in this era, ranked by number of deaths, were <AnchorList items={cities.slice(0, 3)} name={d => `${d.city.name} (${d.num_died})`} url={d => `/profile/place/${d.city.slug}/`} />.
        </p>
      </div>
