        ...
        <div>
          ...
          {newPeopleBorn.length
            ? <div className="rank-sec-body">
              ...
              <PhotoCarousel people={newPeopleBorn.slice(0, 12)} rankAccessor="bplace_name_rank" peopleAll={newPeopleBorn} />
            </div>
            : null}
          ...
          {newPeopleDied.length
            ? <div className="rank-sec-body">
              ...
              <PhotoCarousel people={newPeopleDied.slice(0, 12)} rankAccessor="dplace_name_rank" peopleAll={newPeopleDied} />
            </div>
            : null}
        </div>
      </div>
