...
const BirthyearRanking = ({ person, ranking }) => {
  ...
  return (
    <div>
      <p>
        Among people born in {person.birthyear.name}, {person.name} ranks {ranking.me.rank_unique} out of {person.birthyear.num_born}.&nbsp;
        { betterPeers }
        { worsePeers }
      </p>
      <div>
...
export default BirthyearRanking;
