...
class CountryRanking extends Component {
  ...
  render() {
    ...
    //     betterDeathPeers = <span>Before {person.gender === "M" ? "him" : "her"} are {<AnchorList items={deathcountryRanking.betterPeers} name={d => `${d.name} (${FORMATTERS.year(d.birthyear)})`} url={d => `/profile/person/${d.slug}/`} />}. </span>;
    //   }
    //   if (deathcountryRanking.worsePeers.length) {
    //     worseDeathPeers = <span>After {person.gender === "M" ? "him" : "her"} are {<AnchorList items={deathcountryRanking.worsePeers} name={d => `${d.name} (${FORMATTERS.year(d.birthyear)})`} url={d => `/profile/person/${d.slug}/`} />}.</span>;
    //   }
    // }
