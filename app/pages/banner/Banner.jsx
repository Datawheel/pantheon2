    ...
    <div className="banner">
        <div className="birthlebanner">
          <img className="birthleimage" src="./images/games/birthle.png" alt="" />
            ...
            <br/>
            <br/>
            <button className="button" onClick={event =>  window.location.href='/game/birthle'}>Play<br/>Birthle</button>
        </div>
        ...
        <img className="triviaimage" src="./images/games/trivia_5.png" alt="" />
            ...
            <br/>
            <br/>
            <button className="button" onClick={event =>  window.location.href='/app/trivia'}>Play<br/>Trivia</button>
        </div>
    </div>
  );
};
