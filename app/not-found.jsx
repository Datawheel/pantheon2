      ...
      />*/}
            ...
            <div className="error-container">
              <h2 className="error-msg">
                {messages[rand]}, 404 page not found.
              </h2>
              <div className="profile-footer">
                <div className="footer-container">
                  <h4 className="footer-title">
                    You can go back <a href="/">Home</a> or try one of these
                    Pages instead:
                  </h4>
                ...
                <p>How to all 2366 individuals stack up?</p>
                    ...
                    <li className="footer-carousel-item">
                      ...
                      <h4 className="footer-carousel-item-title">
                        <a href="/profile/person/Roger_Federer">
                          Roger Federer
                        </a>
                      </h4>
                      <p>Tennis Player</p>
                ...
                <p>Dive into the data that makes up Pantheon!</p>
                    ...
                    <li className="footer-carousel-item">
                      ...
                      <h4 className="footer-carousel-item-title">
                        <a href="/profile/occupation/racing-driver">
                          Racing Driver
                        </a>
                      </h4>
                ...
                <p>Create custom visualizations using the Pantheon dataset.</p>
                    ...
                    <li className="footer-carousel-item">
                      ...
                      <h4 className="footer-carousel-item-title">
                        <a href="/profile/person/Vasco_da_Gama">
                          Vasco da Gama
                        </a>
                      </h4>
                      <p>Explorer</p>
