...
const Datasets = () =>
  <div>
    ...
    <dl className="download-dl">
      <dt><a href="https://storage.googleapis.com/pantheon-public-data/person_2020_update.csv.bz2">2020 Person Dataset</a></dt>
      <dd>A bzip compressed comma delimited file containing a row of data per person found in the Panthon 2.0 version released in 2020.</dd>
    </dl>
    <dl className="download-dl">
      <dt><a href="https://storage.googleapis.com/pantheon-public-data/person_2019_update.csv.bz2">2019 Person Dataset</a></dt>
      <dd>A bzip compressed comma delimited file containing a row of data per person found in the Panthon 2.0 version released in 2019.</dd>
    </dl>
    <br />
    <hr />
    <br />
    ...
    <dl className="download-dl">
      <dt><a href="https://storage.googleapis.com/pantheon-public-data/legacy_pantheon.tsv.bz2">pantheon.tsv</a></dt>
      <dd>A tab delimited file containing a row of data per person found in the Panthon 1.0 dataset.</dd>
    </dl>
    <dl className="download-dl">
      <dt><a href="https://storage.googleapis.com/pantheon-public-data/legacy_wikilangs.tsv.bz2">wikilangs.tsv</a></dt>
      <dd>A tab delimited file of all the different Wikipedia language editions that each biography has a presence in.</dd>
    </dl>
    <dl className="download-dl">
      <dt><a href="https://storage.googleapis.com/pantheon-public-data/legacy_pageviews_2008-2013.tsv.bz2">pageviews_2008-2013.tsv</a></dt>
